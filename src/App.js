// we're using "mediaPipe Handpose" to detect hand point. 
// We also use fingerpose library to translate these point into a gesture.
      ...
      if (hand.length > 0) {
        ...
        if (gesture.gestures !== undefined && gesture.gestures.length > 0) {
           ...
           const confidence = gesture.gestures.map(
             ...
             //If we detect multiple gesture we only take the one with more confidence
